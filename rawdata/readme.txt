...
The name of the raw data files will include "I0","z+" and "z-". I have them numbered by trial/result. For example for "result 1" the files will be named as "i01,z+1,z-1, etc".
This teminology explains what type of photo it is. I0 is the best resolution. Z+ is 5mm infront of I0 and z- is 5mm behind I0. 
This is all from moving the image lens. DO NOT MOVE THE LCD. RUINS DATA AND ACCURACY
